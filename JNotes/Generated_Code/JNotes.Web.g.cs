...
namespace JNotes.Web
{
    ...
    public sealed partial class AuthenticationContext : global::System.ServiceModel.DomainServices.Client.ApplicationServices.AuthenticationDomainContextBase
    {
        ...
        public AuthenticationContext() : 
                this(new WebDomainClient<IAuthenticationServiceContract>(new Uri("JNotes-Web-AuthenticationService.svc", UriKind.Relative)))
        {
        }
    ...
    /// <summary>
    /// The DomainContext corresponding to the 'jTreeServiceDomain' DomainService.
    /// </summary>
    public sealed partial class jTreeServiceDomain : DomainContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="jTreeServiceDomain"/> class.
        /// </summary>
        public jTreeServiceDomain() : 
                this(new WebDomainClient<IjTreeServiceDomainContract>(new Uri("JNotes-Web-jTreeServiceDomain.svc", UriKind.Relative)))
        {
        }
        
        /// <summary>
        /// Initializes a new instance of the <see cref="jTreeServiceDomain"/> class with the specified service URI.
        /// </summary>
        /// <param name="serviceUri">The jTreeServiceDomain service URI.</param>
        public jTreeServiceDomain(Uri serviceUri) : 
                this(new WebDomainClient<IjTreeServiceDomainContract>(serviceUri))
        {
        }
        
        /// <summary>
        /// Initializes a new instance of the <see cref="jTreeServiceDomain"/> class with the specified <paramref name="domainClient"/>.
        /// </summary>
        /// <param name="domainClient">The DomainClient instance to use for this DomainContext.</param>
        public jTreeServiceDomain(DomainClient domainClient) : 
                base(domainClient)
        {
            this.OnCreated();
        }
        ...
        /// <summary>
        /// Gets the set of <see cref="TreeData"/> entity instances that have been loaded into this <see cref="jTreeServiceDomain"/> instance.
        /// </summary>
        public EntitySet<TreeData> TreeDatas
        {
            get
            {
                return base.EntityContainer.GetEntitySet<TreeData>();
            }
        }
        
        /// <summary>
        /// Gets an EntityQuery instance that can be used to load <see cref="TreeData"/> entity instances using the 'GetTeamHierarchy' query.
        /// </summary>
        /// <returns>An EntityQuery that can be loaded to retrieve <see cref="TreeData"/> entity instances.</returns>
        public EntityQuery<TreeData> GetTeamHierarchyQuery()
        {
            this.ValidateMethod("GetTeamHierarchyQuery", null);
            return base.CreateQuery<TreeData>("GetTeamHierarchy", null, false, true);
        }
        ...
        protected override EntityContainer CreateEntityContainer()
        {
            return new jTreeServiceDomainEntityContainer();
        }
        
        /// <summary>
        /// Service contract for the 'jTreeServiceDomain' DomainService.
        /// </summary>
        [ServiceContract()]
        public interface IjTreeServiceDomainContract
        {
            
            /// <summary>
            /// Asynchronously invokes the 'GetTeamHierarchy' operation.
            /// </summary>
            /// <param name="callback">Callback to invoke on completion.</param>
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/jTreeServiceDomain/GetTeamHierarchyDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/jTreeServiceDomain/GetTeamHierarchy", ReplyAction="http://tempuri.org/jTreeServiceDomain/GetTeamHierarchyResponse")]
            [WebGet()]
            IAsyncResult BeginGetTeamHierarchy(AsyncCallback callback, object asyncState);
            
            /// <summary>
            /// Completes the asynchronous operation begun by 'BeginGetTeamHierarchy'.
            /// </summary>
            /// <param name="result">The IAsyncResult returned from 'BeginGetTeamHierarchy'.</param>
            /// <returns>The 'QueryResult' returned from the 'GetTeamHierarchy' operation.</returns>
            QueryResult<TreeData> EndGetTeamHierarchy(IAsyncResult result);
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/jTreeServiceDomain/SubmitChangesDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/jTreeServiceDomain/SubmitChanges", ReplyAction="http://tempuri.org/jTreeServiceDomain/SubmitChangesResponse")]
            IAsyncResult BeginSubmitChanges(IEnumerable<ChangeSetEntry> changeSet, AsyncCallback callback, object asyncState);
        ...
        internal sealed class jTreeServiceDomainEntityContainer : EntityContainer
        {
            
            public jTreeServiceDomainEntityContainer()
            {
                this.CreateEntitySet<TreeData>(EntitySetOperations.All);
            }
        }
    }
    ...
    /// </summary>
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/JNotes.Web")]
    ...
    /// <summary>
    /// The 'TreeData' entity class.
    /// </summary>
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/JNotes.Web")]
    public sealed partial class TreeData : Entity
    {
        
        private EntityCollection<TreeData> _childNodes;
        
        private Guid _id;
        
        private Nullable<bool> _isExpanded;
        
        private Nullable<Guid> _parent;
        
        private EntityRef<TreeData> _parentNode;
        ...
        partial void OnisExpandedChanging(Nullable<bool> value);
        partial void OnisExpandedChanged();
        partial void OnParentChanging(Nullable<Guid> value);
        partial void OnParentChanged();
        partial void OnSortorderChanging(Nullable<int> value);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TreeData"/> class.
        /// </summary>
        public TreeData()
        {
            this.OnCreated();
        ...
        /// <summary>
        /// Gets the collection of associated <see cref="TreeData"/> entity instances.
        /// </summary>
        ...
        public EntityCollection<TreeData> ChildNodes
        {
            get
            {
                ...
                {
                    this._childNodes = new EntityCollection<TreeData>(this, "ChildNodes", this.FilterChildNodes, this.AttachChildNodes, this.DetachChildNodes);
                }
        ...
        /// </summary>
        [DataMember()]
        public Nullable<bool> isExpanded
        {
            get
            {
            ...
            set
            {
                if ((this._isExpanded != value))
                {
                    ...
                    this.RaiseDataMemberChanging("isExpanded");
                    this.ValidateProperty("isExpanded", value);
                    this._isExpanded = value;
                    this.RaiseDataMemberChanged("isExpanded");
        ...
        public Nullable<Guid> Parent
        {
            ...
            set
            {
                if ((this._parent != value))
                {
                    ...
                    this.RaiseDataMemberChanging("Parent");
                    this.ValidateProperty("Parent", value);
                    this._parent = value;
                    this.RaiseDataMemberChanged("Parent");
        ...
        /// <summary>
        /// Gets or sets the associated <see cref="TreeData"/> entity.
        /// </summary>
        [Association("TreeData_TreeData", "Parent", "Id", IsForeignKey=true)]
        [XmlIgnore()]
        public TreeData ParentNode
        {
            get
            {
                ...
                {
                    this._parentNode = new EntityRef<TreeData>(this, "ParentNode", this.FilterParentNode);
                }
                return this._parentNode.Entity;
            }
            set
            {
                TreeData previous = this.ParentNode;
                if ((previous != value))
                {
                    this.ValidateProperty("ParentNode", value);
                    if ((previous != null))
                    {
                        this._parentNode.Entity = null;
                        previous.ChildNodes.Remove(this);
                    }
                    if ((value != null))
                    {
                    ...
                    {
                        this.Parent = default(Nullable<Guid>);
                    }
    ...
    public sealed partial class UserRegistrationContext : DomainContext
    {
        ...
        public UserRegistrationContext() : 
                this(new WebDomainClient<IUserRegistrationServiceContract>(new Uri("JNotes-Web-UserRegistrationService.svc", UriKind.Relative)))
        {
        }
